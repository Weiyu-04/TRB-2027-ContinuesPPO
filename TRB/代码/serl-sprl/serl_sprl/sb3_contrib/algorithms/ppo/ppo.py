...
from serl_sprl.sb3_contrib.serl_policies import ActorCriticPolicy
...
class PPO(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        if self.env is not None:
            ...
            assert buffer_size > 1 or (not normalize_advantage), "`n_steps * n_envs` must be greater than 1."
