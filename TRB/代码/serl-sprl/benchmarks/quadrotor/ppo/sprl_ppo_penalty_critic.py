...
def main(penalty_factor: float, seeds: list):
    ...
    algorithm_config = PPODiffProjConfig(
        hyperparams=common.get_hyperparams_ppo_diff_proj(
    ...
    path = f"SPRL/Quadrotor/PPO/PenaltyCritic/{penalty_factor}"
    ...
    experiment.run_training(tags=["SPRL", "Quadrotor", "PPO", "PenaltyCritic"])
