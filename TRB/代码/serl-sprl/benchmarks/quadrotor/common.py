...
def get_num_total_timesteps_sac():
    # due to time constraints in the benchmark paper
    return 100000
...
def get_policy_kwargs_a2c():
    return {
        ...
        "log_std_init": -1.141665217419653,
        "squash_output": True,
        "squash_mean": True,
    }
...
def get_hyperparams_a2c():
    return A2CHyperparameters(
        learning_rate=1e-4,  # 0.0008449999440828863,
        ent_coef=0.0,
        max_grad_norm=0.5,
        n_steps=15,
        gae_lambda=0.9,
...
def get_hyperparams_a2c_diff_proj(use_penalty_critic: bool, use_per_sample_loss: bool, penalty_factor: float):
    return A2CDiffProjHyperparameters(
        learning_rate=0.0008449999440828863,
        ent_coef=0.0,
        max_grad_norm=0.5,
        n_steps=15,
        gae_lambda=0.9,
