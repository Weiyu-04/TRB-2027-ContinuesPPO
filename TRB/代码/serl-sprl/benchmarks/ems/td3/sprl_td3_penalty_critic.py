...
def main(penalty_factor: float, seeds: list):
    ...
    path = f"SPRL/EMS/TD3/PenaltyCritic/{penalty_factor}"
    ...
    experiment.run_training(tags=["SPRL", "EMS", "TD3", "PenaltyCritic"])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seeds", type=common.parse_seeds, default=common.get_seeds_td3(), required=False)
